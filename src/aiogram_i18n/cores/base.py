...
class BaseCore(ABC, Generic[Translator]):
    ...
    def __init__(
        ...
        ----------
        path: Union[str, Path]
            The path to the directory containing translation files. It can be a string or a Path
            object.
        default_locale: Optional[str] = None
            The default locale to be used for translations. If not provided, it will default to
            None.
        locales_map: Optional[Dict[str, str]] = None
            A mapping of locale strings to their fallback locales. This can be used to provide
            fallback translations for specific locales.
